========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet assignment2.1
========================================================================

AppWizard a créé cette application assignment2.1 pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application assignment2.1.


assignment2.1.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé assignment2.1.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
