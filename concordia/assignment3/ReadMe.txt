========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet assignment3
========================================================================

AppWizard a créé cette application assignment3 pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application assignment3.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé assignment3.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
